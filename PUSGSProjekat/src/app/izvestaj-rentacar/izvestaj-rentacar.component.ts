...
//import { ChartsModule, WavesModule} from '../node_modules/angular-bootstrap-md/index.ts'

@Component({
  selector: 'app-izvestaj-rentacar',
  templateUrl: './izvestaj-rentacar.component.html',
  styleUrls: ['./izvestaj-rentacar.component.css']
})
export class IzvestajRentacarComponent implements OnInit {
